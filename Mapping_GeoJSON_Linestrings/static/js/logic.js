...
// let light = L.tileLayer('https://api.mapbox.com/styles/streets-v11/tiles/{z}/{x}/{y}?access_token={accessToken}', {
...
d3.json(torontoData).then(function(data) {
  ...
  L.geoJSON(data, {
      ...
      onEachFeature: function(feature, layer) {
        layer.bindPopup("<h3> Ariline: "+ feature.properties.airline + "</h3> <hr><h3> Destination: "+ feature.properties.dst
+ "</h3>")      }
  }).addTo(map);
});
